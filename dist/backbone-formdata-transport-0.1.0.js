/Applications /Library /Network /System /User Information /Users /Volumes /bin /cores /dev /etc /home /mach_kernel /net /private /sbin /tmp /usr /var backbone-formdata-transport-0.1.0 dist/ node_modules/
// Generated by CoffeeScript 1.6.3
(function() {
  var FormDataTransport, FormDataTransportModel, hasKeys, make_utils, transport_name, _ref,
  ...
  FormDataTransportModel = (function(_super) {
    ...
    function FormDataTransportModel() {
      ...
      _ref = FormDataTransportModel.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    FormDataTransportModel.prototype.set_file_field = function(field_name, file) {
      this.files = this.files || {};
      return this.files[field_name] = file;
    };

    FormDataTransportModel.prototype.sync = function(method, model, options) {
      var error, log, pending_files, xhr, _ref1,
        _this = this;
      _ref1 = make_utils('Backbone.FormDataTransport.Model'), log = _ref1[0], error = _ref1[1];
      options.model = this;
  ...
  $.ajaxTransport(transport_name, function(options, origOptions, jqXHR) {
    ...
    return {
      send: function(headers, complete) {
        var error, event, field_name, file, files, form_data, handler, key, log, model, value, x_csrf, xhr, _ref1, _ref2, _ref3, _ref4;
        _ref1 = make_utils("" + transport_name + "-transport"), log = _ref1[0], error = _ref1[1];
        model = options.model;
        ...
        _ref2 = (options != null ? options.events : void 0) || {};
        for (event in _ref2) {
          handler = _ref2[event];
          xhr.addEventListener(event, handler, false);
        }
        _ref3 = (options != null ? options.upload_events : void 0) || {};
        for (event in _ref3) {
          handler = _ref3[event];
